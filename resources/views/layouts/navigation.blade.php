<nav x-data="{ open: false }" class="bg-gray-900 border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20">
            ...
            <!-- Hamburger -->
            <div class="-mr-40 flex items-center .hidden-sm">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-1000 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class=".hidden-sm">
