    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-input id="phone" class="block mt-4 w-full" type="phone" name="phone" :value="old('phone')" required />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="password_confirmation" class="block mt-4 w-full"
                                type="password"
                                name="password_confirmation" required />
            </div>

            <div class="flex items-center justify-end mt-4">
                <a class="underline text-sm text-gray-600 hover:text-gray-900" href="{{ route('calendar') }}">
